...
#include "./mavlink_msg_manual_override_location.h"
#include "./mavlink_msg_battery_fs_warning.h"
#include "./mavlink_msg_payload_spool_status.h"
#include "./mavlink_msg_water_level_sensor.h"
#include "./mavlink_msg_fmu_system_id.h"
#include "./mavlink_msg_prx_distance.h"
#include "./mavlink_msg_failsafe_reason.h"
